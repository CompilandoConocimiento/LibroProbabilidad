...
\clearpage
    ...
    \chapter{Variables Aleatorias}
        ...
        \section{Definición}
            ...
            Una variable aleatoria es un función que asigna a cada elemento, en el espacio muestral
            a un número real.
            ...
            \subsection{Función Probabilidad}
                ...
                Es tan sencilla como $f_{X}(x) = P(X = x)$
                Y tiene que cumplir que la suma de todos los posibles valores de la variable aleatoria
                den uno.

                Es decir, es la probabilidad de $x$ que para un elemento del espacio muestral nuestra
                variable tome en valor de x.
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    $f_{X}(x) = {3 \choose 3} \pfrac{1}{2}^x \pfrac{1}{2}^{3-x}$ para $x \in \Set{0, 1, 2, 3}$.
            ...
            % ==============================================================
            \clearpage
            \subsection{Función Probabilidad Acumulada}
                ...
                Podemos ver a la acumulada como una función fundamental, tal que podemos escribir a todas las
                demás:
                \begin{itemize}
        ...
        \section{Esperanza o Media}
            ...
            Decimos que el valor esperado o esperanza media de la variable $X$
            con $f_{X}(x)$ se define como:
            \begin{equation*}
                \mu_{X} = E(X) = \sum_x x P(X = x) = \sum_x x f_X(x)
            \end{equation*}
        ...
        \section{Momentos Centrales}
            ...
            \subsection{Propiedades}
                ...
                \begin{itemize}
                    ...
                    \item
                        ...
                        $v(X) = E(X^2) - \mu^2$ donde $E(X^2)$ es un segundo momento
            ...
            \subsection{Función Generadora de Momentos}
                ...
                de momentos evaluada en $t = 0$ da como resultado el k-ésimo momento.
