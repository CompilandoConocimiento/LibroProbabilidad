    ...
    \chapter{Introducción}
        ...
        \section{}
            ...
            \subsection{Notación}
                ...
                \begin{itemize}
                    \item $\epsilon$ Experimento
                    \item $A$ Evento
                    \item $P(A)$ Probabilidad del evento $A$
                    \item $\omega$ Es un Conjunto de posibles resultados del experimento
                    \item $X$, es una variable libre, una característica del experimento, es decir
                        $X: \omega \to \Reals$
                \end{itemize}
