    ...
    \chapter{Variables Aleatorias Discretas}
        ...
        \section{Función Probabilidad $f_X $}
            ...
            \begin{SmallIndentation}[1em]
                ...
                $f_{X}(x) = {3 \choose 3} \Wrap{\frac{1}{2}}^x \Wrap{\frac{1}{2}}^{3-x}$ para $x \in \Set{0, 1, 2, 3}$.
        ...
        % ==============================================================
        \clearpage
        \section{Función Probabilidad Acumulada $F_X$}
            ...
            \subsection{Propiedades}
                ...
                \begin{itemize}
                    ...
                    \item 
                        ...
                        $X$ existe si y solo si $\sum_x |x| f_X(x) < \infty$
        ...
        \section{Varianza}
            ...
            Pero usando esta definición podemos dar muchas otras definiciones utiles:
            \begin{align*}
                v(X) 
                    &= E((X - \mu)^2)                       \\
                    &= \sum_{x} (x - \mu)^2 P(X = x)        \\
        ...
        % ==============================================================
        \clearpage
        \section{Distribuciones Famosas}
